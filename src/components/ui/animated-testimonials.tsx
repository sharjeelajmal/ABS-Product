...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className={cn("max-w-sm md:max-w-4xl mx-auto px-0 md:px-4 lg:px-8 py-8 md:py-12", className)}>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Image
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center border border-[var(--glass-border)] shadow-[0_0_40px_rgba(0,0,0,0.45)]"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
        ...
        <div className="flex justify-between flex-col py-2 md:py-4">
          ...
          <div className="flex gap-4 pt-8 md:pt-0">
            <button
              ...
              className="h-9 w-9 rounded-full bg-secondary border border-[var(--glass-border)] flex items-center justify-center group/button hover:border-[var(--primary)]/40 transition-colors"
            >
